    ...
    def play_round(self):
        ...
        if self.round_number == 64:
            if group_id == "A":
                yield (
                    ExitSurveyPage,
                    dict(age='1',gender='1',education='1',Q1='1',Q2='1',Q3='1',Q8='1',attention='1',crt_bat=100,crt_widget=100,crt_lake=100,phone='6666')
                )
            elif group_id in "BD":
                yield (
                    ExitSurveyPage,
                    dict(age='1',gender='1',education='1',Q1='1',Q2='1',Q3='1',Q4='1',Q6='1',Q8='1',attention='1',crt_bat=100,crt_widget=100,crt_lake=100,phone='6666')
                )
            else:
                yield (
                    ExitSurveyPage,
                    dict(age='1',gender='1',education='1',Q1='1',Q2='1',Q3='1',Q4='1',Q7='1',Q8='1',attention='1',crt_bat=100,crt_widget=100,crt_lake=100,phone='6666')
                )
            time.sleep(10)
